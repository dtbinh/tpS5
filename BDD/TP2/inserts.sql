...
INSERT INTO Articles VALUES (17,'Rubber duck','jaune');
...
INSERT INTO Catalogue VALUES (6,17,1000000.00);--Prix qui dépasse la limite
INSERT INTO Catalogue VALUES (1,1,36.10);--Prix inférieur à 0
INSERT INTO Articles VALUES (17,'test','jaune');--Test contrainte double pk
DELETE FROM fournisseurs where fid = 4; --test
...
/*Q2.4*/
select distinct fnom from fournisseurs natural join catalogue where prix >= 10 and prix <= 20;
select distinct fnom from fournisseurs natural join catalogue where prix >= 10 intersect select distinct fnom from fournisseurs natural join catalogue where prix <= 20;
/*Q2.5*/
select distinct anom from articles natural join catalogue where acoul = 'vert' or acoul='rouge' and prix < 20;
/*Q2.6*/
